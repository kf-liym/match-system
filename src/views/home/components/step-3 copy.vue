  ...
  <div class="step-3">
    ...
    <el-tabs v-model="activeName" @tab-click="handleClick">
      <el-tab-pane label="个人项目" name="first">
        <el-collapse v-model="personActive" class="match-item" @change="handleChange">
          <el-collapse-item
            :name="personIndex"
          ...
          >
            ...
            <div class="personal-info-item">
              ...
              >
                ...
                <!-- <div class="step-3__row clearfix">
                  <div class="step-3__col" style="width: 100%; max-width: 300px;"></div>
                  <div class="step-3__col">
                    <div class="grid-content" v-show="person.selectProjectObj[0].category ===1">
                      <el-form-item label prop="setProjectObj[0]" label-width="0px"></el-form-item>
                    </div>
                  </div>
                </div>-->
                <!-- <el-row>
      ...
      <el-tab-pane label="对练项目" name="second">
        <el-collapse v-model="duelActive" class="match-item" @change="handleChange">
          <el-collapse-item
            name="1"
